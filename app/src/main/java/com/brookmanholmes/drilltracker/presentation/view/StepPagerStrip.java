...
public class StepPagerStrip extends View {
    ...
    public StepPagerStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        mPrevTabPaint.setColor(res.getColor(R.color.colorPrimaryLight));

        mSelectedTabPaint = new Paint();
        mSelectedTabPaint.setColor(res.getColor(R.color.colorPrimary));

        mSelectedLastTabPaint = new Paint();
        mSelectedLastTabPaint.setColor(res.getColor(R.color.colorPrimaryDark));
